					...
					<div class="panel-heading text-white" style="background: #F8F8FF;">
						<div class="row">
							...
							<div class="col-md-offset-3 col-md-3">
								<div style="padding-top: 10px; font-size: 1.5em">작성자:
									${content.writer}</div>
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-offset-1 col-md-5">
								<p class="last-update">
									<fmt:parseDate value="${content.regDate}" pattern="yyyy-MM-dd'T'HH:mm" var="parsedDateTime" type="both"/>
							...
							<div class="btn-group col-md-offset-1 col-md-5">
								...
								<c:if test="${content.writer == user.userId}">
									<a class="btn btn-primary"
										href="/MyWeb/modify.board?bId=${content.boardId}">수정하기</a>
