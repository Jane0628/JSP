...
/*
 - 서블릿이란 웹 페이지를 자바 언어로만 구성하는 것이다.
 즉, jsp 파일을 자바 언어로만 구성하는 것. (...con.jsp)
 그동안 톰캣을 사용해서 jsp 파일을 자동으로 class로 변환했다면
 이제는 직접 클래스를 생성해서 클래스로 요청을 처리해 보자. 
 */
...
public class ServletBasic extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) 
		...
		w.write(htmlCode); // 버퍼에 응답하고자 하는 데이터를 작성하기
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//겍체의 메서드를 통해 파라미터값 가져오거나, 페이지 이동이 가능하다.
